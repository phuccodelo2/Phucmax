...
local doorPositions = {
	Vector3.new(-469, 40, -102), Vector3.new(-468, 40, 8), Vector3.new(-467, 40, 112),
	Vector3.new(-466, 40, 220), Vector3.new(-355, 40, 219), Vector3.new(-354, 40, 112),
	Vector3.new(-353, 40, 4), Vector3.new(-353, 40, -100)
}
